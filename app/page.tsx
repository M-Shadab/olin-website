          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-0 divide-y md:divide-y-0 md:divide-x divide-black/10">
            ...
            <div className="group px-6 md:px-12 py-8 md:py-4 text-center">
              ...
              <p className="text-gray-500 leading-relaxed font-light">
                Every linen, every day. Industrial consistency with boutique
                care.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className={frameworkGridStyle}>
            ...
            <div className={frameworkCardStyle}>
              ...
              <p className="text-gray-500 text-sm leading-relaxed font-light">
                Curated bathroom and room amenities from premium brands,
                packaged for your brand.
              </p>
            </div>
            ...
            <div className={frameworkCardStyle}>
              ...
              <p className="text-gray-500 text-sm leading-relaxed font-light">
                Housekeeping carts, cleaning chemicals, and staff uniforms
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-12 md:p-24">
          <div className="max-w-md">
            ...
            <p className="text-lg text-gray-600 leading-relaxed mb-10 font-light">
              "We bridge the gap between industrial scale and boutique
