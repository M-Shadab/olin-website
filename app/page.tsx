        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex md:grid md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-12 overflow-x-auto md:overflow-visible snap-x snap-mandatory pb-8 md:pb-0 -mx-6 px-6 md:mx-0 md:px-0 scrollbar-hide">
             ...
             <div className="group cursor-pointer flex flex-col items-center min-w-[240px] md:min-w-0 snap-center">
                 ...
                 <h3 className="font-playfair text-xl dark:text-gray-300 dark:md:text-navy text-navy mb-2 group-hover:text-gold transition-colors duration-300">Laundry & Linen</h3>
             ...
             <div className="group cursor-pointer flex flex-col items-center min-w-[240px] md:min-w-0 snap-center">
                 ...
                 <h3 className="font-playfair text-xl dark:text-gray-300 dark:md:text-navy text-navy mb-2 group-hover:text-gold transition-colors duration-300">Room Support</h3>
             ...
             <div className="group cursor-pointer flex flex-col items-center min-w-[240px] md:min-w-0 snap-center">
                 ...
                 <h3 className="font-playfair text-xl dark:text-gray-300 dark:md:text-navy text-navy mb-2 group-hover:text-gold transition-colors duration-300">Housekeeping</h3>
             ...
             <div className="group cursor-pointer flex flex-col items-center min-w-[240px] md:min-w-0 snap-center">
                 ...
                 <h3 className="font-playfair text-xl dark:text-gray-300 dark:md:text-navy text-navy mb-2 group-hover:text-gold transition-colors duration-300">Facility Supply</h3>
             ...
             <div className="group cursor-pointer flex flex-col items-center min-w-[240px] md:min-w-0 snap-center">
                 ...
                 <h3 className="font-playfair text-xl dark:text-gray-300 dark:md:text-navy text-navy mb-2 group-hover:text-gold transition-colors duration-300">Sustainability</h3>
